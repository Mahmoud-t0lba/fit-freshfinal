...
class CartScreenCat extends StatefulWidget {
  static const String id = "cart_screen";

  @override
  _CartScreenCatState createState() => _CartScreenCatState();
}

class _CartScreenCatState extends State<CartScreenCat> {
  Store _store = Store();
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData) {
              for (var product in snapshot.data.docs) {
                ...
                if (data['category'] == name && data['size'] == '250 GM') {
                  products.add(
                    Product(
                      pid: product.id,
                      pName: data['name'],
